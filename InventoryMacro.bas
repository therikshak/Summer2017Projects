Attribute VB_Name = "InventoryMacro"
...
Private Function DeleteReports() As Boolean
    ...
    'path to the folder
    path = "C:\Users\" & username & "\SharePoint\Supply Chain Operations - Documents\Projects\InventoryReports\"
...
Private Function DownloadReports() As Boolean
    ...
    Set myInbox = myNameSpace.Folders(1).Folders("Inventory Reports")
    ...
    username = (Environ$("Username"))
    saveFolder = "C:\Users\" & username & "\SharePoint\Supply Chain Operations - Documents\Projects\InventoryReports\"
...
Private Sub CreatePivot()
    ...
    fileName = "C:\Users\" & username & "\SharePoint\Supply Chain Operations - Documents\Projects\InventoryReports\" & m & "_" & d & "_" & y & "_" & "InventoryReport.xlsx"
