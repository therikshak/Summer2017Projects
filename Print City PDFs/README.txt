Instructions for Using the PDF Script
	...
	-The keyboard and mouse should be used while the script is running with the 
...
1. Open up VBS and login and then minimize the screen

2. Double click on "PrintOrdersToPDF" to launch the script
